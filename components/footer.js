...
class Footer extends Component {
  ...
  <div className="px-4 py-4 sm:px-6 lg:px-8 lg:col-span-3">
    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
      ...
      <div className="grid grid-cols-12 gap-4 ">
        ...
        <div className='col-span-6'>
          ...
          <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-300">
            <a className="hover:opacity-75" href=""> Hotel bookings </a>
            <a className="hover:opacity-75" href=""> Travel packages </a>
            <a className="hover:opacity-75" href=""> Meal Plans </a>
            <a className="hover:opacity-75" href=""> Journey tracking </a>
          </nav>
        </div>
      </div>
    </div>

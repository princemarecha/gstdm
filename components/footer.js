...
class Footer extends Component {
  ...
  <div class="grid grid-flow-row-dense grid-cols-3 grid-rows-3 gap-x-1 m-3">
  <div><Image
      src={Img1}
      alt="Gallery"
    /></div>
  ...
  <div class="px-4 py-4 sm:px-6 lg:px-8 lg:col-span-3">
    <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
      ...
      <p class="font-medium">
        ...
        <ul class="mt-8 space-y-2 text-sm">
          <li>Phone: +263 772 340 485</li>
          <li>Email: info@getawayspecialisedtours.com</li>
          <li>Address: 180 Fife Avenue, Harare</li>
        </ul>
      ...
      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div>
          ...
          <nav class="flex flex-col mt-4 space-y-2 text-sm text-gray-300">
            <a class="hover:opacity-75" href=""> Hotel bookings </a>
            <a class="hover:opacity-75" href=""> Travel packages </a>
            <a class="hover:opacity-75" href=""> Meal Plans </a>
            <a class="hover:opacity-75" href=""> Journey tracking </a>
          </nav>
        </div>
      </div>
    </div>

    <div class="pt-12 mt-5 border-t border-gray-800">
      <div class="text-sm text-gray-300 sm:items-center sm:justify-between sm:flex">
        <p class="mt-0 sm:mt-0">
          &copy; 2022 Getaway Specialised Tours and Destination Management.
        </p>
      </div>
    </div>
  </div>

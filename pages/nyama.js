...
var requestOptions = {
  ...
  const res = await fetch("https://api.test.hotelbeds.com/hotel-content-api/1.0/hotels?fields=all&language=ENG&from=1&to=1&useSecondaryLanguage=false", requestOptions);

    ...
    <div>
                ...
                <div >
                    <section className='grid grid-cols-12'>
                        ...
                        <div className="py-6 px-24  col-span-12">
                         <form>
                            <div>
                                <label htmlFor="message" className="block mb-2 font-medium text-zinc-50 text-left bg-amber-800 p-3">3x Double or twin shared external bathroom</label>
                          <form>
                                        <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-400 light:text-gray-400 text-left  py-3 px-4 shadow-lg ">Lorel ipsum bla bla</label>
                                        <div className='border-b  '></div>
                                        <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-400 light:text-gray-400 text-left py-3 px-4 shadow-xl">Lorel ipsum bla bla</label>
                                        <div className='border-b '></div>
                                    </form>
                                </div>
                                <br></br>
                                ...
                                <div>
                                <label htmlFor="message" className="block mb-2 font-medium text-zinc-50 text-left bg-amber-800 p-3">3x Double Standard</label>
                          <form>
                                        <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-400 light:text-gray-400 text-left  py-3 px-4 shadow-lg ">Lorel ipsum bla bla</label>
                                        <div className='border-b  '></div>
                                        <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-400 light:text-gray-400 text-left py-3 px-4 shadow-xl">Lorel ipsum bla bla</label>
                                ...
                                <div>
                                <label htmlFor="message" className="block mb-2 font-medium text-zinc-50 text-left bg-amber-800 p-3">3x Suite Standard</label>
                          <form>
                                        <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-400 light:text-gray-400 text-left  py-3 px-4 shadow-lg ">Lorel ipsum bla bla</label>
                                        <div className='border-b  '></div>
                                        <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-400 light:text-gray-400 text-left py-3 px-4 shadow-xl">Lorel ipsum bla bla</label>
